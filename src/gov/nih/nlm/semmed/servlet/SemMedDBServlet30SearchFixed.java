 ...
 *
 */
public class SemMedDBServlet30SearchFixed extends HttpServlet { 

	private static final long serialVersionUID = 1L;
	private static Log log = LogFactory.getLog(SemMedDBServlet30SearchFixed.class);
	...
	public void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException{
		...
		try {
			...
			if(qry != null && (qry.equals("1010")) || (qry.equals("1011"))) {
				con = ds.getConnection();
				s = con.createStatement();
				String dbquery = null;
				if(qry.equals("1010"))
					dbquery = qryTemp.replace("$1", list1010);
				else if(qry.equals("1011"))
